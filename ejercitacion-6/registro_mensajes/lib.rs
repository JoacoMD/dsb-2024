...
mod registro_mensajes {
    ...
    mod tests {
        ...
        #[ink::test]
        fn default_works() {
            let registro_mensajes = RegistroMensajes::default();
            assert_eq!(registro_mensajes.get(), false);
        }

        /// We test a simple use case of our contract.
        #[ink::test]
        fn it_works() {
            let mut registro_mensajes = RegistroMensajes::new(false);
            assert_eq!(registro_mensajes.get(), false);
            registro_mensajes.flip();
            assert_eq!(registro_mensajes.get(), true);
        }
    }
